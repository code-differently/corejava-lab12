...
Write an complete `ColorRange.java` in package `labs.lab12.part_c.activity01`, which when given a wavelength in nanometers will return the corresponding color in the visible spectrum.
